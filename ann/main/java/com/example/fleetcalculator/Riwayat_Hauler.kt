...
class Riwayat_Hauler : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_riwayat_hauler)
        ...
        val riwayat = sharedPref.getString("riwayat_hauler", null)
