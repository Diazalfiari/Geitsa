...
class MF_PlanToActual : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinnerFleet = findViewById(R.id.spinnerFleetPlanToActual)
    ...
    private fun hitungMF() {
        ...
        tvHasilMF.text = "Match Factor Actual to Plan: %.3f".format(hasil)
        ...
        lastTelegramMsg = """
🔗 LAPORAN MATCH FACTOR (MF) ACTUAL TO PLAN

👤 Nama                     : $username
🔑 NRP                      : $nrp
🚗 Fleet                    : $fleet

🚚 Hauler (Baris 1)         : n Aktual=${firstHaulerData.first}, WH Aktual=${firstHaulerData.second}, Pdty Plan=${firstHaulerData.third}
🛠️ Loader (Baris 1)         : n Aktual=${firstLoaderData.first}, WH Aktual=${firstLoaderData.second}, Pdty Plan=${firstLoaderData.third}

🧮 Total Hauler             : ${"%.3f".format(totalHauler)}
🧮 Total Loader             : ${"%.3f".format(totalLoader)}
🔢 Match Factor Actual to Plan : ${"%.3f".format(hasil)}
...
🗓️ Tanggal                  : $timestamp
        ...
        val formattedRiwayat = "$timestamp,,,,,${firstHaulerData.first},${firstHaulerData.second},${firstHaulerData.third},${firstLoaderData.first},${firstLoaderData.second},${"%.3f".format(hasil)},MF Actual to Plan"
