...
class MF_Macro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinnerFleet = findViewById(R.id.spinnerFleetMacro)
    ...
    private fun hitungMF() {
        ...
        tvHasilMF.text = "Match Factor Macro: %.3f".format(hasil)
...
🔢 Match Factor Macro  : ${"%.3f".format(hasil)}
