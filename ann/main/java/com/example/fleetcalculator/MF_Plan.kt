...
class MF_Plan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mf_plan)

        spinnerFleet = findViewById(R.id.spinnerFleetPlan)
        ...
        // Setup fleet spinner - pakai layout spinner_item_black & spinner_dropdown_item_black
    ...
    private fun buatInput(hint: String): EditText {
        ...
        et.setTextColor(resources.getColor(android.R.color.black))         // teks hitam
        et.setHintTextColor(resources.getColor(android.R.color.black))     // hint juga hitam
        return et
    }
    ...
    private fun hitungMF() {
        ...
        tvHasilMF.text = "Match Factor Plan: %.3f".format(hasil)
        ...
        lastTelegramMsg = """
🔗 LAPORAN MATCH FACTOR (MF) PLAN

👤 Nama                : $username
🔑 NRP                 : $nrp
🚗 Fleet               : $fleet

🚚 Hauler (Baris 1)    : n=${firstHaulerData.first}, WH=${firstHaulerData.second}, Pdty=${firstHaulerData.third}
🛠️ Loader (Baris 1)    : n=${firstLoaderData.first}, WH=${firstLoaderData.second}, Pdty=${firstLoaderData.third}

🧮 Total Hauler        : ${"%.3f".format(totalHauler)}
🧮 Total Loader        : ${"%.3f".format(totalLoader)}
🔢 Match Factor Plan   : ${"%.3f".format(hasil)}
...
🗓️ Tanggal             : $timestamp
        ...
        val formattedRiwayat = "$timestamp,,,,,${firstHaulerData.first},${firstHaulerData.second},${firstHaulerData.third},${firstLoaderData.first},${firstLoaderData.second},${"%.3f".format(hasil)},MF Plan"
